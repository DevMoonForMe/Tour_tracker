    ...
    <div className="space-y-6">
      ...
      {!activeTrip ? (
        <div className="bg-white p-8 rounded-xl border border-slate-200 text-center">
          ...
          <Link to="/trips" className="inline-flex items-center justify-center px-4 py-2 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition-colors">
            Go to Trips
          </Link>
        </div>
      ) : (
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link to="/members" className="text-sm text-primary-600 hover:text-primary-700 font-medium">View All</Link>
              </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Link to="/expenses" className="flex flex-col items-center justify-center p-4 bg-slate-50 rounded-xl hover:bg-primary-50 transition-colors text-slate-700 hover:text-primary-700 font-medium border border-slate-100 hover:border-primary-100 text-center">
                  <TrendingDown className="w-6 h-6 mb-2" />
                  <span className="text-sm">Add Expense</span>
                </Link>
                <Link to="/advances" className="flex flex-col items-center justify-center p-4 bg-slate-50 rounded-xl hover:bg-primary-50 transition-colors text-slate-700 hover:text-primary-700 font-medium border border-slate-100 hover:border-primary-100 text-center">
                  <PiggyBank className="w-6 h-6 mb-2" />
                  <span className="text-sm">Add Advance</span>
                </Link>
                <Link to="/members" className="flex flex-col items-center justify-center p-4 bg-slate-50 rounded-xl hover:bg-primary-50 transition-colors text-slate-700 hover:text-primary-700 font-medium border border-slate-100 hover:border-primary-100 text-center">
                  <Users className="w-6 h-6 mb-2" />
                  <span className="text-sm">Add Member</span>
                </Link>
                <Link to="/settlement" className="flex flex-col items-center justify-center p-4 bg-slate-50 rounded-xl hover:bg-primary-50 transition-colors text-slate-700 hover:text-primary-700 font-medium border border-slate-100 hover:border-primary-100 text-center">
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
             <div className="flex items-center justify-between mb-4">
               ...
               <Link to="/settlement" className="text-sm text-primary-600 hover:text-primary-700 font-medium">Detailed View</Link>
             </div>
